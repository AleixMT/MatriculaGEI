...
/**
 * Classe per a crear la multillista amb llistes estàtiques
 * Aquesta classe crearà llistes dinàmiques per a alumnes i per a assignatures
 * @author Cristina Izquierdo i Aleix Mariné
 *
 */
public class MultillistaEstatica implements TADMultillista{
